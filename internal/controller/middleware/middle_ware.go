...
import (
	"github.com/Abdullayev65/online_test/internal/usecase/user"
...
func New(tokenJWT *utill.TokenJWT, useCase *user.UseCase) *MW {
	return &MW{TokenJWT: tokenJWT, UseCase: useCase}
}
