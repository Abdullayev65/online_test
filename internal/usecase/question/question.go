...
func (u *UseCase) GetListQuestion(c context.Context, size int, page int) ([]question_srvc.Detail, error) {
...
func (u *UseCase) CreateQuestion(c context.Context, create *question_srvc.Create) (*question_srvc.Detail, error) {
	if create.Text == nil {
